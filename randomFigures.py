...
while True:
    ...
    pygame.draw.rect(screen, (0,0,255), (345,250,210,100))
    pygame.draw.rect(screen, (0,0,0), (475,290,70,60))
    pygame.draw.rect(screen, (78,99,0), (376,300,40,50))
    
    
    for g in range(0,WIDTH, 10):
        pygame.draw.line(screen, (0,255,0), (g,400), (g,450), FILLED2)
